...
class OrderSerailizer(serializers.ModelSerializer):
    ...
    def get_shippingAddress(self, obj):
        try:
            shippingAddress = ShippingAddressSerialzer(obj.shippingaddress, many=False).data
        except:
            shippingAddress = False
        return shippingAddress
        
    def get_orderProducts(self, obj):
        orderProducts = obj.orderproduct_set.all()
        serializer = OrderItemSerailzer(orderProducts, many=True)
        return serializer.data
